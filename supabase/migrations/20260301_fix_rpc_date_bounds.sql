-- Fix: Add sargable date bounds to generate_series JOINs in get_stats RPC
-- This allows PostgreSQL to use idx_events_created for the daily trend queries
-- instead of sequential scanning the entire events table.
